...
#include "hardware_AT_dog/HardwareATDog.h"
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn HardwareATDog::on_init(
...
std::vector<hardware_interface::StateInterface> HardwareATDog::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> HardwareATDog::export_command_interfaces()
{
...
return_type HardwareATDog::read(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
{
    // joint states
    for (int i(0); i < 12; ++i)
    {
...
return_type HardwareATDog::write(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
{
    // send command
    // for (int i(0); i < 12; ++i)
    // {
...
PLUGINLIB_EXPORT_CLASS(HardwareATDog, hardware_interface::SystemInterface)
